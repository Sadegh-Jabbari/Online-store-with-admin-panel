                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route("sliders.update", $slider->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-form mb-2 w-100">
                                <label for="slider_uri" class="input-form-label active-field">عنوان انگلیسی</label>
                                <input type="text" name="slider_uri" id="slider_uri" class="active-field" value="{{$slider->slider_uri}}">
                            </div>
                            <div class="input-form mb-2 w-100">
                                <label for="slider_name" class="input-form-label active-field">متن جایگزین</label>
                                <input type="text" name="slider_name" id="slider_name" class="active-field" value="{{$slider->slider_name}}">
                            </div>
                            <div class="input-form mb-2 w-100">
                                <label for="slider_number" class="input-form-label active-field">شماره اسلایدر</label>
                                <input type="number" name="slider_number" id="slider_number" class="active-field" value="{{$slider->slider_number}}">
                            </div>
