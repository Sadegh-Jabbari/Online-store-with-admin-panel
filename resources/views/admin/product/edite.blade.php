                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <button><i class="fa fa-unlock"></i></button>
                        </div>
                        <form action="{{route("prods.update", $prod->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="input-form mb-2 w100">
                                ...
                                <div class="discount w-100 d-none">
                                    <select name="discount" id="discount" class="js-example-basic-single w-100">
                                        ...
                                        @for($i = 1; $i <= 100; $i++)
                                            <option value="{{$i}}" @if($prod->discount == $i) selected @endif>{{$i."%"}}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <textarea name="prodLNDesc" id="summernote" cols="30" rows="10">{{$prod->prodLNDesc}}</textarea>
