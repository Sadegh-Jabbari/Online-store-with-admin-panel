                    ...
                    <div class="card-body">
                        <div class="px-5 pb-5 mb-3 position-relative" style="border: 4px solid #ef394e; border-radius: 8px">
                            ...
                            <div class="position-relative">
                                <form action="{{route("navs.update", $nav->id)}}" method="POST" id="nav-form">
                                    @csrf
                                    @method('PUT')
                                    <div class="d-flex mb-2">
                                        <label for="main_nav_url" class="w-25">عنوان منو اختصاصی</label>
                                        <input type="text" name="main_nav_url" id="main_nav_url" class="w-50" value="{{$nav->main_nav_url}}">
                                    </div>
                                    <div class="d-flex mb-2">
                                        <label for="main_nav_name" class="w-25">اسم منو</label>
                                        <input type="text" name="main_nav_name" id="main_nav_name" class="w-50" value="{{$nav->main_nav_name}}">
                                    </div>
                                    <div class="d-flex mb-2">
                            ...
                            <div class="position-relative">
                                <form action="{{route("navs.update", $cat->id)}}" method="POST" id="cat-form">
                                    @csrf
                                    @method('PUT')
                                    <div class="d-flex mb-2">
                                        <label for="cat_nav_title" class="w-25">عنوان دسته بندی</label>
                                        <input type="text" name="cat_nav_title" id="cat_nav_title" class="w-50" value="{{$cat->cat_nav_title}}">
                                    </div>
                                    <div class="d-flex mb-2">
                                        <label for="cat_nav_url" class="w-25">آدرس صفحه منو</label>
                                        <input type="text" name="cat_nav_url" id="cat_nav_url" class="w-50" value="{{$cat->cat_nav_url}}">
                                    </div>
                                    <div class="d-flex mb-2">
                            ...
                            <div class="position-relative">
                                <form action="{{route("navs.update", $sub->id)}}" method="POST" id="sub-form">
                                    @csrf
                                    <div class="d-flex mb-2">
                                        <label for="sub_nav_title" class="w-25">عنوان زیرمنوی دسته بندی</label>
                                        <input type="text" name="sub_nav_title" id="sub_nav_title" class="w-50" value="{{$sub->sub_nav_title}}">
                                    </div>
                                    <div class="d-flex mb-2">
                                        <label for="sub_nav_url" class="w-25">آدرس صفحه</label>
                                        <input type="text" name="sub_nav_url" id="sub_nav_url" class="w-50" value="{{$sub->sub_nav_url}}">
                                    </div>
                                    <div class="d-flex mb-2">
