            ...
            <section class="mb-4">
                <div class="card">
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-center"><strong>ایجاد صفحه</strong></h5>
                    </div>
                    <div class="card-body">
                        <form action="{{url("/")}}/adm/prods" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex mb-2">
                                <label for="prodName" class="w-25">عنوان صفحه</label>
                                <input type="text" name="prodName" id="prodName" class="w-75">
                            </div>
                            <div class="d-flex mb-2">
                                <label for="prodUrl" class="w-25">آدرس صفحه</label>
                                <input type="text" name="prodUrl" id="prodUrl" class="w-75">
                            </div>
                            <div class="d-flex mb-2">
                                <label for="prodIMG" class="w-25">عکس صفحه</label>
                            ...
                            <div class="d-flex mb-2">
                                <label for="prodShDesc" class="w-25">توضیح کوتاه درباره صفحه؟ واقعا؟</label>
